...
{
	public static var psychEngineVersion:String = '0.4.2e'; // This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Evil Psych Engine v" + psychEngineVersion, 12);
