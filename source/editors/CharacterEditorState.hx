...
import stages.elements.BGSprite;
...
class CharacterEditorState extends MusicBeatState
{
	...
	function reloadBGs()
	{
		...
		if (onPixelBG)
		{
			...
			var bgSky:BGSprite = new BGSprite('week6/weeb/weebSky', OFFSET_X - (playerXDifference / 2) - 300, 0 - playerYDifference, 0.1, 0.1);
			bgLayer.add(bgSky);
			bgSky.antialiasing = false;

			var repositionShit = -200 + OFFSET_X - playerXDifference;

			var bgSchool:BGSprite = new BGSprite('week6/weeb/weebSchool', repositionShit, -playerYDifference + 6, 0.6, 0.90);
			bgLayer.add(bgSchool);
			bgSchool.antialiasing = false;

			var bgStreet:BGSprite = new BGSprite('week6/weeb/weebStreet', repositionShit, -playerYDifference, 0.95, 0.95);
		...
		{
			var bg:BGSprite = new BGSprite('week1/stageback', -600 + OFFSET_X - playerXDifference, -300, 0.9, 0.9);
			bgLayer.add(bg);

			var stageFront:BGSprite = new BGSprite('week1/stagefront', -650 + OFFSET_X - playerXDifference, 500, 0.9, 0.9);
